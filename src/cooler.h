...
private:
    ...
    const int WET_CYCLE_TIME = 30;               // duration of the wet cycle in ms before the fans start in seconds
    const int POSTRUN_FAN_TIME = 180;             // duration of the fan run after the cooler has been turned off
